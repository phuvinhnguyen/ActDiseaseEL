...
INPUT_CORPUS="meddata/history.benchmark.jsonl"
...
python link_text.py \
    "$INPUT_CORPUS" \
    ../doid-results/history.OneNetLLM.jsonl \
    -l onenet-llm \
    --article_format \
    --custom_kb
...
python link_text.py \
    "$INPUT_CORPUS" \
    ../doid-results/history.GraphLLM.jsonl \
    -l graph-llm \
    --article_format \
    --custom_kb
...
echo "  Output: ../doid-results/history.GraphLLM.jsonl"
